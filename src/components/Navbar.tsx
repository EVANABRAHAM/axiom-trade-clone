...
export function Navbar() {
    return (
        <div id="platform-layout" className="hidden sm:block">
                ...
                <div className="relative flex hidden sm:flex flex-1 min-w-[0px]">
                    ...
                    <div className="flex overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] ">
                        <div className="flex flex-row gap-[4px] justify-start items-center">
                            <div>
                                <a href="/discover?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                            ...
                            <div>
                                <a href="/pulse?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-primaryBlue">
                                        <span className="text-[14px] font-medium">Pulse</span>
                                    </button>
                                </a>
                            </div>
                            <div>
                                <a href="/trackers?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                                        <span className="text-[14px] font-medium">Trackers</span>
                                    </button>
                                </a>
                            </div>
                            <div>
                                <a href="/perpetuals?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                                        <span className="text-[14px] font-medium">Perpetuals</span>
                                    </button>
                                </a>
                            </div>
                            <div>
                                <a href="/yield?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                                        <span className="text-[14px] font-medium">Yield</span>
                                    </button>
                                </a>
                            </div>
                            <div>
                                <a href="/vision?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                                        <span className="text-[14px] font-medium">Vision</span>
                                    </button>
                                </a>
                            </div>
                            <div>
                            ...
                            <div>
                                <a href="/rewards?chain=sol">
                                    <button className="flex flex-row h-[32px] text-nowrap px-[8px] xl:px-[14px] justify-start items-center [transition:none] duration-0 hover:bg-primaryBlue/20 hover:text-primaryBlue hover:[transition:background-color_135ms_ease-in-out,color_135ms_ease-in-out] rounded-[4px] text-textPrimary">
                                        <span className="text-[14px] font-medium">Rewards</span>
                                    </button>
                                </a>
                            </div>
                        </div>
                            ...
                            <div className="relative flex ">
                                <div data-state="closed" className="w-full">
                                    <button className="hover:brightness-125 border-[2px] flex flex-shrink-0 flex-row h-[32px] pl-[8px] pr-[6px] gap-[6px] justify-center items-center rounded-full transition-all duration-150 ease-in-out active:scale-[0.96]" type="button" style={{ borderColor: 'rgba(20, 241, 149, 0.1)' }}>
                                        <img alt="Solana" loading="lazy" width="16" height="16" decoding="async" data-nimg="1" src="/images/sol-fill.svg" style={{ color: 'transparent' }} />
                                ...
                                <div className="flex-shrink-0">
                                    <button className="w-fit min-w-max bg-primaryStroke flex flex-row h-[32px] px-[12px] py-[8px] gap-[8px] justify-center items-center rounded-full hover:bg-opacity-80 transition-colors hover:bg-secondaryStroke/80">
                                        ...
                                        <div className="hidden xl:flex flex-shrink-0 whitespace-nowrap flex-row gap-[4px] justify-start items-center">
                                            <img alt="SOL" loading="lazy" width="16" height="16" decoding="async" data-nimg="1" src="/images/sol-fill.svg" style={{ color: 'transparent' }} />
                                        ...
                                        <div className="hidden xl:flex flex-shrink-0 whitespace-nowrap flex-row gap-[4px] justify-start items-center">
                                            <img alt="USDC" loading="lazy" width="18" height="28" decoding="async" data-nimg="1" src="/images/usdc-perps.svg" style={{ color: 'transparent' }} />
                                            <span className="text-[14px] font-semibold text-textPrimary">0</span>
                                        </div>
                                        <i className="text-textPrimary ri-arrow-down-s-line text-[18px]"></i>
                                    </button>
                        ...
                        <span className="contents">
                            <button type="button" className="flex flex-row w-[28px] h-[28px] justify-center items-center rounded-full relative overflow-visible transition-all duration-150 ease-in-out active:scale-[0.96] border-transparent bg-primaryStroke hover:bg-secondaryStroke/80 hover:border-transparent">
                                <div className="relative w-full h-full rounded-full overflow-hidden">
                                    ...
                                    <img alt="User" draggable="false" loading="eager" decoding="async" data-nimg="fill" className="object-cover transition-all duration-150 brightness-100 hover:brightness-110" src="data:image/svg+xml,%0A%20%20%20%20%3Csvg%20width%3D%22120%22%20height%3D%22120%22%20viewBox%3D%220%200%20120%20120%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%0A%20%20%20%20%20%20%3Cdefs%3E%0A%20%20%20%20%20%20%20%20%3ClinearGradient%20id%3D%22grad-1443314399%22%20x1%3D%220%25%22%20y1%3D%220%25%22%20x2%3D%22100%25%22%20y2%3D%22100%25%22%3E%0A%20%20%20%20%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20style%3D%22stop-color%3Ahsl(239%2C%2079%25%2C%2059%25)%3Bstop-opacity%3A1%22%20%2F%3E%0A%20%20%20%20%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20style%3D%22stop-color%3Ahsl(16%2C%2079%25%2C%2049%25)%3Bstop-opacity%3A1%22%20%2F%3E%0A%20%20%20%20%20%20%20%20%3C%2FlinearGradient%3E%0A%20%20%20%20%20%20%3C%2Fdefs%3E%0A%20%20%20%20%20%20%3Crect%20width%3D%22120%22%20height%3D%22120%22%20fill%3D%22url(%23grad-1443314399)%22%20%2F%3E%0A%20%20%20%20%20%20%3Ctext%0A%20%20%20%20%20%20%20%20x%3D%2250%25%22%0A%20%20%20%20%20%20%20%20y%3D%2250%25%22%0A%20%20%20%20%20%20%20%20dominant-baseline%3D%22central%22%0A%20%20%20%20%20%20%20%20text-anchor%3D%22middle%22%0A%20%20%20%20%20%20%20%20font-family%3D%22system-ui%2C%20-apple-system%2C%20sans-serif%22%0A%20%20%20%20%20%20%20%20font-size%3D%2248%22%0A%20%20%20%20%20%20%20%20font-weight%3D%22600%22%0A%20%20%20%20%20%20%20%20fill%3D%22white%22%0A%20%20%20%20%20%20%20%20opacity%3D%220.95%22%0A%20%20%20%20%20%20%3ECC%3C%2Ftext%3E%0A%20%20%20%20%3C%2Fsvg%3E%0A%20%20" style={{ position: 'absolute', height: '100%', width: '100%', inset: '0px', color: 'transparent' }} />
                                </div>
